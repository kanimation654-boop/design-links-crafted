...
const ur: Dict = {
  ...
  ceoTitle: "قیادت",
  ceoName: "منظور احمد نذر",
  ceoPos: "چیف ایگزیکٹو آفیسر",
  ceoBody: "منظور احمد نذر ڈیزائن لنکس کنسٹرکشن اینڈ پراپرٹی کے بانی اور چیف ایگزیکٹو آفیسر ہیں۔ وہ کمپنی کی قیادت وژن، تجربے اور لگن سے کرتے ہیں اور اعلیٰ معیار برقرار رکھتے ہوئے جدید حل فراہم کرنے کے لیے پرعزم ہیں۔",
